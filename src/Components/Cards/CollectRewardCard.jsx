    ...
    <div>
      <div className="w-[150px] h-[200px] rounded-lg overflow-hidden shadow-lg bg-gray-700 bg-opacity-80   flex flex-col justify-between">
        ...
        <div className="flex flex-col items-center ">
          <div className="font-normal text-xl text-white  text-center text-balance">Collect Daily Rewards</div>
        </div>

        {/* Button Section */}
        <div className='flex justify-center '>
          <button  onClick={handleOpen} className="bg-[#756AB6] w-full font-normal  text-white  py-2 px-4 border  rounded-3xl transition duration-300">
            Button
          </button>
